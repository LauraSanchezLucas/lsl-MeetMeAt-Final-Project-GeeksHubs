...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    [
      ...
      {id:2, name: 'Summer Music Fest', description: 'A two-day music festival featuring popular bands and artists from around the world, like Soffie Ellar, Five Band, Pablo Martinez.... ', place: '', date: '', hour: '', createdAt: '2023-04-11', updatedAt: '2023-04-11'},
      ...
      {id:6, name: 'Shutter Stroll', description: 'Join us for a photography walk and discover the city´s hidden gems. We will explore different neighborhoods and capture the city´s unique architecture and street art. All skill levels welcome.', place: 'C/ Almirante Cadarso numero 26, Valencia', date: '2023-05-10', hour: '10:00', createdAt: '2023-04-11', updatedAt: '2023-04-11'},
